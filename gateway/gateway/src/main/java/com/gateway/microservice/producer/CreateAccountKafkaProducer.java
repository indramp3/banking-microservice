...
@Configuration
public class CreateAccountKafkaProducer {
    ...
    @Value(value = "${kafka.topic.create-account-resp}")
    private String topicResponse;

    @Bean
    public ReplyingKafkaTemplate<String, GetAccountDTO.Request, String> createAccountRequestReplyKafkaTemplate(
