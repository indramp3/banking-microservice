...
@Configuration
public class CreateTransactionKafkaProducer {
    ...
    @Value(value = "${kafka.topic.create-transaction-resp}")
    private String topicResponse;

    @Bean
    public ReplyingKafkaTemplate<String, GetAccountDTO.Request, String> createTransactionRequestReplyKafkaTemplate(
