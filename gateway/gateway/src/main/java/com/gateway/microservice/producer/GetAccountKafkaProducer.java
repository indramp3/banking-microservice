...
@Configurable
public class GetAccountKafkaProducer {
    ...
    @Value(value = "${kafka.topic.get-account-resp}")
    private String topicResponse;

    @Bean
    public ReplyingKafkaTemplate<String, GetAccountDTO.Request, String> getAccountRequestReplyKafkaTemplate(
